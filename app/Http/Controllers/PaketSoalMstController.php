...

{
    ...
    public function store(Request $request)
    {
        ...
        // Menambahkan jenis_soal dari request
        $data['jenis_soal'] = $request->jenis_soal_add;
    ...
    public function update(Request $request, $id)
    {
        ...
        // Menambahkan jenis_soal dari request
        $data['jenis_soal'] = isset($request->jenis_soal[0]) ? $request->jenis_soal[0] : null;
...

    {
        ...
        if($getdata->fk_paket_soal_kecermatan_mst){
            ...
            if($updatedatamst['total_soal']){
                
                PaketSoalKecermatanMst::find($getdata->fk_paket_soal_kecermatan_mst)->update($updatedatamst);

            }else{

                $updatedatamst['fk_paket_soal_kecermatan_mst'] = 0;
                PaketSoalKecermatanMst::find($getdata->fk_paket_soal_kecermatan_mst)->update($data);
