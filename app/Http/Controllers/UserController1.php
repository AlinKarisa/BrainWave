...
//        $hasilujiankecermatan = UPaketSoalKecermatanMst::where('fk_user_id', Auth::user()->id)->where('fk_paket_mst', $id)->where('is_mengerjakan', 2)->groupBy('fk_paket_dtl')->orderBy('created_at', 'desc')->get();        
        ...
        $data_param = [
            'submenu', 'menu', 'data', 'paketdtl', 'paketvideo', 'paketpdf', 'hasilujian', 'idpaketdtl', 'paketzoom','paketdtlkecermatan','hasilujiankecermatan', 'kategoris',
            'detail_kats', 'cermat_kats', 'materi_kats', 'zoom_kats', 'tab'
        ];
    ...
    public function ujian($id)
    {
        ...
        if ($upaketsoalmst->is_mengerjakan == 0) {
            ...
            if($dataloop[0]->fk_u_paket_soal_kecermatan_mst){
                ...
                $data_param = [
                    'submenu','menu','upaketsoalmst','soalmst','now','umapelmst', 'dataloop', 'soals'
                ];
                ...
                $data_param = [
                    ...
                    'submenu', 'menu', 'upaketsoalmst', 'now', 'dataloop'
                ];
    ...
    public function ujiankecermatan(Request $request, $id)
    {
        ...
        $data_param = [
            'submenu','menu','upaketsoalmst','soalmst','now', 'soals'
        ];
    ...
    public function detailhasil($id)
    {
        ...
        if ($upaketsoalmst->is_mengerjakan == 1) {
            ...
            $data_param = [
                ...
                'submenu', 'menu', 'upaketsoalmst', 'extend', 'soalmst'
            ];
