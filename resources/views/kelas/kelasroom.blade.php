            ...
            <div class="row">
              <div class="col-12">  
                    ...
                    <div class="box-class" id="kelas-{{$kelas->id}}" status-kelas="{{$kelas->time_status}}">
                        ...
                        <a class="btn btn-sm btn-warning active" href="{{url('kelasroom/'.$kelas->id)}}">Live Class</a>
                        <a class="btn btn-sm btn-warning" href="{{url('kelasroom/'.$kelas->id.'/presensi')}}">Data Presensi</a>
                        </div>
                    </div>
