...
@section('content')
    ...
    <section class="content home">
        <div class="container-fluid">
            ...
            <div class="col-2">
            <a class="btn btn-block @if($today) btn-outline-primary @else btn-primary @endif" href="{{url('mentor')}}">Semua</a>
            </div>
            <div class="col-2">
            <a class="btn btn-block @if($today) btn-primary @else btn-outline-primary @endif" href="{{url('mentor')}}?today=1">Hari ini</a>
            </div>
            </div>
              ...
              <div class="col-xl-4 col-md-6">  
                    ...
                    <div class="box-class">
                        ...
                        <div class="box-class-foot"> 
                          <a class="btn btn-sm btn-warning" href="{{url('mentorroom/'.$kelas->id)}}">Lihat Kelas</a>
                        </div>
                    </div>
          ...
          <div class="modal-content">
           ...
           <div class="modal-header">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary" id="modal-sumbit">Save changes</button>
            </div>
