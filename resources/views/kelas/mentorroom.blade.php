...
<h1 class="m-0">Mentor Classroom</h1>
@endsection
            ...
            <div class="row">
              <div class="col-12">  
                    ...
                    <div class="box-class">
                        ...
                        <a class="btn btn-sm btn-warning active" href="{{url('mentorroom/'.$kelas->id)}}">Live Class</a>
                        <a class="btn btn-sm btn-warning" href="{{url('mentorroom/'.$kelas->id.'/presensi')}}">Data Presensi</a>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              @if(!$kelas->mentor_open)
              <i>Note : Tampilan dibawah tidak terlihat user bila belum buka live oleh mentor.</i><br><br>
              @endif
              @if($kelas->link)
        ...
        <div class="modal-content">
          ...
          <form method="post" id="formPresensi" class="form-horizontal">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary btn-presensi" idform="{{$kelas->id}}">Presensi</button>
            </div>
          </form>
        </div>
      <!-- /.modal-content -->
