...
@media (max-width: 768px) {
    ...
    /* Responsive for the list of soal */
    ._soal {
        display: flex;
        flex-wrap: wrap;
...
@media (max-width: 576px) {
    ...
    /* Adjust button and text for mobile screens */
    .btn-sm {
        padding: 8px;
        font-size: 0.85em;
    }
      ...
      <div class="card card-border">
        <div class="card-body">
          ...
          <div class="row mt-3">
              ...
              <div class="tab-pane fade {{$key->no_soal==1 ? 'show active' : ''}}" id="pills-{{$key->id}}" role="tabpanel">
                  ...
                  <div class="mb-3 p-3 card-border" style="border-radius: 10px;">
                    <div class="row">
                      ...
                      @if(!empty($key->u_paket_soal_ktg_r->ket))
                            <span
                                style="
            ...
            <div class="mb-0 card-border p-3 div-waktu">
            ...
            <div class="mb-0 card-border p-3">
              ...
              <h6 class="mb-0">Lanjut Kecermatan</h6>
              </button>
              @else
              <center class="mb-1">Sudah Selesai?</center>
