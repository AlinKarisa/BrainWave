        ...
        <div class="card-bodyx">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="{{url('belipaketktg')}}">Beli Paket</a>
              </li>
          ...
          <div class="row" style="align-items:center">
            ...
            <div class="col-md-3 col-lg-3">
              <div class="input-group mb-3 mt-3 mb-md-0 mt-md-0">
              ...
              <div class="card">
                <div class="card-body py-3 px-3">
                  <div class="row mb-3 align-items-center" style="flex-wrap: nowrap !important;">
                    ...
                    <div class="col-8">
                      <h4 class="fs-6 mb-0 ml-3"><b>{{$key->judul}}</b></h4>
                      <div class="text-sm mt-2 ml-3">{{$key->ket}}</div>
                    </div>
                    <div class="col-auto ps-0 align-self-start">
                      <div class="rounded-1 px-1 py-1 bg-lightgreen text-green text-xs" style="font-size: 9pt;">Tersedia
                      </div>
                    </div>
                  </div>
