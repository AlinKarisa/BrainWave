              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="40%">{{$key->user_r->name}} @if($no==1)<i style="color:gold" class="ti-medall btn-icon-prepend"></i>@endif</td>

                    <td width="10%" style="text-align:left" class="font-weight-bold">{{$key->set_nilai}}</td>
                  <td width="10%" style="text-align:left" class="font-weight-bold">{{$key->set_predikat}}</td>
