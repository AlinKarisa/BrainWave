                ...
                <div class="tab-content tab-hasil-ujian">
                                  ...
                                  <form method="post" id="formHapus_{{$key->id}}" class="form-horizontal">
                                    @csrf
                                        <div class="modal-body">
                                          Apakah kamu yakin ingin membatalkan pembelian paket {{$key->paket_mst_r->judul ?? "Data Tidak Tersedia"}}?
                                        </div>
                                        <!-- Modal footer -->
                          ...
                          <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td width="40%">{{$key->paket_mst_r->judul ?? "Data Tidak Tersedia"}}</td>
                  ...
                  <div id="batal" class="tab-pane"><br>
                        ...
                        <div class="row mb-3">
                          <div class="col-md-8">
                              <p>No.Pembelian : <b>{{$key->merchant_order_id}}</b></p>
                              <p>Pembelian : {{ isset($key->paket_mst_r->judul) ? $key->paket_mst_r->judul : "Data Tidak Tersedia" }}</p>
                              <p>{{Carbon\Carbon::parse($key->created_at)->translatedFormat('l, d F Y , H:i:s')}}</p>
                              @if($key->channel_r)
                              <div class="row mt-3 mb-3" style="align-items:center">
                                <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
