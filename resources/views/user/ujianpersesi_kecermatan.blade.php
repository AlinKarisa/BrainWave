        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="cardx card-border w-100">
                <div class="card-bodyx">
                    ...
                    <h3 class="font-weight-bold"><b>Latihan {{ $umapelmst->judul }}</b></h3>
                    </p>
                    <div class="row">
                        ...
                        <h3 style="border:solid 1px #ddd; padding:8px 4px; margin:0;">Kolom {{$upaketsoalmst->current_kolom()}}</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="card card-border w-100 mb-4">
                                <div class="card-body">
                                    @if ($umapelmst->fk_paket_soal_kecermatan_mst != 0)
                                    <div class="mb-4 card-border div-waktu">
                                        <div class="mb-0" id="sesiend">
                                        @if($umapelmst->jenis_waktu != 2)
                                            <h6 class="fw-600 text-center mb-3">Waktu Tersisa</h6>
                                        @else
                                            <h6 class="fw-600 text-center mb-3">Waktu Sesi Tersisa</h6>
                                        @endif
                                    ...
                                    @else 
                                    <div class="mb-4 card-border div-waktu d-none">
                                        <div class="mb-0" id="sesiend">
                                        @if($umapelmst->jenis_waktu != 2)
                                            <h6 class="fw-600 text-center mb-3">Waktu Tersisa</h6>
                                        @else
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm _btn-waktu bg-white">
                            <h6 id="end">Waktu Soal Tersisa<br><span id="hours"></span><span id="mins"></span><span id="secs"></span></h6>
                            </button>
    ...
    <div class="modal-dialog">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            ...
            <div class="modal-body pb-0">
                <center style="font-size:18px"><i style="color:#7C3AED" class="fa fa-check-square"></i> <span style="color:#7C3AED" class="modal-title"><b>Selesaikan Sesi Ini?</b></span></center>
                <h5 class="mt-2">
...
//        $(document).bind("contextmenu", function(e) {
  //          return false;
    //    });
        ...
        var countDownDateSesi = new Date("{{$selesai}}").getTime()+ 5000;
    ...
    var countDownDate = new Date("{{$soalmst->selesai}}").getTime();
        ...
        const now = new Date('{{$now}}');
        now.setSeconds(now.getSeconds() + j);
        j++;
