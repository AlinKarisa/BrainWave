                                        ...
                                        <div class="" style="overflow: hidden">
                                            ...
                                            <div class="row mt-3" style="justify-content: center">
                                                <div class="col-12 col-md-3"
                                                    style="background: #ccf1d0e3 !important;max-width:24% !important;margin-left:0.5%;margin-right:0.5%;border-radius:10px">
                                                    <div class="px-3 py-5 card-border"
                                                        ...
                                                        <div class=""><span
                                                                style="font-size: 36pt;color: #7C3AED;font-weight: bold;display: block;">{{ $upaketsoalmst->point <= 0 ? 0 : $upaketsoalmst->point }}</span>
                                                        </div>

                                                    </div>
                                                </div>
                                                @foreach ($soalmst as $item)
                                                    <div class="col-12 col-md-3"
                                                        style="background: #D6CAEC !important;max-width:24% !important;margin-left:0.5%;margin-right:0.5%;border-radius:10px">
                                                        <div class="px-3 py-5 card-border"
                                                            style="text-align:center;border-radius:10px;display:flex;flex-direction:column;justify-content:center">
                                                            ...
                                                            <h6 class="fw-bold mt-3">{{ $item->ket }}</h6>
                                                            <div class=""><span
                                                                    style="font-size: 26pt;color: #7C3AED;font-weight: bold;display: block;">{{ $item->point <= 0 ? 0 : $item->point }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                                                            ...
                                                                            @if ($upaketsoalmst->bagi_jawaban == 1)
                                                                                @if ($key->jawaban_user)
                                                                                    @if ($key->jawaban_user == $key->jawaban)
                                                                                        <span
                                                                                            class="badge badge-outline-success ms-2">Benar</span>
                                                                                    @else
                                                                                        <span
                                                                                            class="badge badge-outline-danger ms-2">Salah</span>
                                                                                    @endif
                                                                                @else
                                                                                    <span
                                                                                        class="badge badge-outline-secondary ms-2">Kosong</span>
                                                                                @endif
                                                                            @endif
                                                                        </h4>
                                                                    </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-sm-4 col-md-4 col-lg-4"
                                                                style="padding-right:2.5px;"><i
                                                                    ...
                                                                    style="font-size:12px;">Kosong</span></div>
                                                            <div class="col-sm-4 col-md-4 col-lg-4"
                                                                style="padding-right:2.5px;"><i
                                                                    style="font-size:18px;color:#63bb64"
                                                                    class="fa fa-square"></i> <span
                                                                    style="font-size:12px;">Benar</span></div>
                                                            <div class="col-sm-4 col-md-4 col-lg-4"
                                                                style="padding-right:2.5px;"><i
                                                                    style="font-size:18px;color:#FF4747"
                                                                    class="fa fa-square"></i> <span
                                                                    style="font-size:12px;">Salah</span></div>
                                                        </div>
                                                    @endif
