        ...
        <div class="card-body">
          ...
          <div class="row mt-3">
            ...
            <div class="mb-4 card-border p-3 br-10">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#modalkecermatan" class="btn-block btn btn-primary btn-sm">
              <h6 class="mb-0">Lanjut Kecermatans</h6>
              </button>
              @else
              <center class="mb-1">Sudah Selesai?</center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body pb-0">
        <center style="font-size:18px"><i style="color:#7C3AED" class="fa fa-check-square"></i> <span style="color:#7C3AED" class="modal-title"><b>Submit Jawaban Sekarang?</b></span></center>
...
<div class="modal fade" id="modalkecermatan">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body pb-0">
        <center style="font-size:18px"><i style="color:#7C3AED" class="fa fa-check-square"></i> <span style="color:#7C3AED" class="modal-title"><b>Submit Jawaban Sekarang dan lanjut Ujian Kecermatan ?</b></span></center>
        <h5 class="mt-2"><center>Jawaban yang telah disubmit tidak dapat diubah?</center></h5>
      </div>

      <!-- Modal footer -->
      <div class="modal-footer" style="display:block;text-align: center;border-top:0px solid">
        <button type="button" class="btn btn-primary" id="btn-lanjutsesi" upaketsoalmst="{{Crypt::encrypt($upaketsoalmst->id)}}">Submit</button>
        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Tutup</button>
      </div>
...
<script>
  ...
  $(document).ready(function(){
      ...
      $(document).on('click', '#btn-lanjutsesi', function(e) {
            document.getElementById("end").innerHTML = "Submit jawaban !!";
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        Swal.fire({
                            ...
                            html: "Halaman akan diarahakan ke ujian kecermatan...",
                            icon: 'success',
      ...
      $(document).on('click', '#btn-selesai', function (e) {
        ...
        @if($upaketsoalmst->jenis_waktu == 1)
            // Jika jenis_waktu adalah 1, gunakan $upaketsoalmst->selesai
            countDownDate = new Date("{{$upaketsoalmst->selesai}}").getTime();
        @elseif($upaketsoalmst->jenis_waktu == 3)
            // Jika jenis_waktu adalah 3, gunakan $upaketsoalmst->waktu yang berupa integer menit
            // Mengubah menit menjadi milidetik dan menambahkannya ke waktu sekarang
            countDownDate = new Date().getTime() + ({{$upaketsoalmst->waktu}} * 60 * 1000); 
        @endif
        
        // Run myfunc every second
        i = 0;
        var myfunc = setInterval(function() {
            // Ambil waktu saat ini dan tambahkan detik setiap iterasi
            const now = new Date('{{$now}}');
            now.setSeconds(now.getSeconds() + i);
            i++;
        
            // Hitung selisih antara waktu selesai dan waktu saat ini
            ...
            // Menampilkan hasil ke elemen dengan ID yang sesuai
