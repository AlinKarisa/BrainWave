                                                        ...
                                                        function matkats(&$kategoris, $matkats, $isroot){ 
                                                            foreach($matkats as $id=>$kat){
                                                                if($id && isset($kategoris[$id])){
                                                                    $hide = $isroot ? '' : ' d-none';
                                                                    echo '
                                                                    <li class="row md-4 d-inline-block'.$hide.'" id="kat-'.$id.'" katid="'.$id.'">
                                                                    <div class="grid-margin stretch-card" style="width:100%;">
                                                                        <div class="card card-border" style="height: 100%; width:100%;">
                                                                            <div class="card-body">
                                                            ...
                                                            foreach($matkats as $id=>$kat){
                                                                if(!$id || !isset($kategoris[$id])){
                                                                    foreach($kat as $m){  
                                                                        echo '
                                                                        <li class="row md-4 d-inline-block">
                                                                    ';
                                                                        if($m->jenis==1){
                                                                        echo '
                                                                        <div class="grid-margin stretch-card" style="width:100%;">
...
';
                                                        ...
                                                        function detailkats(&$kategoris, $matkats, $isroot){
                                                            ...
                                                            foreach($matkats as $id=>$kat){
                                                                if($id && isset($kategoris[$id])){
                                                                    $hide = $isroot ? '' : ' d-none';
                                                                    echo '
                                                                    <li class="row col-md-4 d-inline-block'.$hide.'" id="kat-'.$id.'" katid="'.$id.'">
                                                                    <div class="grid-margin stretch-card" style="width:100%">
                                                                        <div class="card card-border" style="height: 100%; width:100%;">
                                                                            <div class="card-body">
                                                                            <div class="row align-items-center mb-3">
                                                            ...
                                                            foreach($matkats as $id=>$kat){
                                                                if(!$id || !isset($kategoris[$id])){
                                                                    ...
                                                                    foreach($kat as $m){  
                                                                        ...
                                                                        echo '
                                                                    <li class="row col-md-4 d-inline-block">
                                                                    ';
                                                                ...
                                                                <div class="card card-border" style="height: 100%; width:100%;">
                                                                    <div class="card-body p-3">
                                                                        <div class="row align-items-center mb-3"
                                                                            ...
                                                                            <div class="col-8 ps-4">
                                                                                <h6 class="text-sm text-grey ml-3">Latihan</h6>
                                                                                <h4 class="fs-6 mb-0 text-start ml-3">
                                            ...
                                            <div id="hasillatihan" class="tab-pane {{ $tab == 'hasillatihan' ? 'active' : '' }}">
                                                <hr>
                                                <br>
                                ...
                                if (response.status == true) {
                                    ...
                                    if (response.idpaket) {
                                        Swal.fire({
                                            ...
                                            /* Read more about isConfirmed, isDenied below */
                                            if (result.isConfirmed) {
                                                window.location.href = '{{ url('ujiankecermatan') }}/' + response.idpaket;
                                            } else if (result.isDenied) {

                                                // Selesaikan Ujian kecermatan
                                                idpaketmst = response.idpaket;
                                                $.ajaxSetup({
                                                    headers: {
                                                        'X-CSRF-TOKEN': $(
                                                ...
                                                // Akhir Selesaikan Ujian kecermatan
