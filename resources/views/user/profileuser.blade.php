        ...
        <div class="card-bodyx">
          ...
          <p class="card-description">
            ...
            <div class="col-md-12 mb-4">
				<div class="card card-border profile-cover">
					<div class="card-body">
						<div class="d-flex align-items-end" style="">
							...
							<div class="ms-4 pb-4">
								<h6 class="mb-1 text-blackgreen fs-3 fw-bold">{{Auth::user()->name}}</h6>
								<div class="text-muted mb-0 text-sm">{{Auth::user()->username}}</div>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="col-md-3 mb-3 mb-sm-0">
              ...
              <div class="card-body" style="padding: 0px;">
                  ...
                  <div class="akun-saya">
                    <ul class="nav nav-pills py-3" role="tablist">
                      <li class="nav-item">
                        <a class="btn btn-sm btn-light nav-link active" data-toggle="pill" href="#akuntab"><i class="fa fa-address-book-o me-2"></i> Akun</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn btn-sm btn-light nav-link" data-toggle="pill" href="#profiltab"><i class="fa fa-user-o me-2"></i> Profil</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn btn-sm btn-light nav-link" data-toggle="pill" href="#passwordtab"><i class="ti-key me-2"></i> Ubah Password</a>
                      </li>
                      <li class="nav-item">
                        <a class="btn btn-sm btn-light nav-link" data-toggle="pill" href="#vouchertab"><i class="ti-credit-card me-2"></i> Voucher</a>
                      </li>
                    </ul>
                  </div>
								</div>
            ...
            <div class="col-md-9 grid-margin transparent">
                <div class="tab-content tab-hasil-ujian">
				  ...
				  <div class="card card-border w-100">
					<div class="card-header bg-white fw-bold py-3 fs-5">Detail Akun</div>
					<div class="card-body">
                    ...
                    @csrf
                      ...
                      <button type="submit" class="btn btn-primary bg-blue text-white">Simpan Perubahan</button>
                    </form>
					</div>
					</div>
                  </div>
				  ...
				  <div class="card card-border w-100">
					<div class="card-header bg-white fw-bold py-3 fs-5">Detail Profil</div>
					<div class="card-body">
                    ...
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ttl" id="ttl" placeholder="Tanggal Lahir" value="{{Auth::user()->ttl}}"> 
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
				  ...
				  <div class="card card-border w-100">
					<div class="card-header bg-white fw-bold py-3 fs-5">Ubah Password</div>
					<div class="card-body">
				  ...
				  <div class="card card-border w-100">
				  <div class="card-header bg-white fw-bold py-3 fs-5">Voucher</div>
					<div class="card-body">
                    <div class="accordion accordion-multi-colored" id="accordion" role="tablist">
                      @forelse($voucher as $key)
                      <div class="card">
                        <div class="card-header p-3 bg-green" role="tab" id="heading-{{$key->id}}">
                          <h6 class="mb-0">
                            <a class="collapsed text-white" data-bs-toggle="collapse" href="#collapse-{{$key->id}}" aria-expanded="false" aria-controls="collapse-{{$key->id}}">
                              <b style="font-size:30px;font-weight:bold">{{$key->kode}}</b> (Voucher promo {{$key->tipe==1 ? formatRupiah($key->jumlah) : $key->jumlah."%"}})
                            </a>
                          </h6>
                        </div>
                        <div id="collapse-{{$key->id}}" class="collapse bg-green text-white" role="tabpanel" aria-labelledby="heading-{{$key->id}}" data-parent="#accordion" style="">
                          <div class="card-body">
                            {{$key->ket}}
                          </div>
                        </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    if (hash && $(hash).length) { // Memastikan elemen dengan ID hash ada
        $('a[data-toggle="tab"]').removeClass('active');
        $('.tab-pane').removeClass('active show');
        $('a[href="' + hash + '"]').tab('show');
        $(hash).addClass('active show'); // Mengaktifkan tab pane
    }
});
