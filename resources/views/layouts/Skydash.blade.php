  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center d-sm-none">
        ...
        <a class="navbar-brand brand-logo mr-5" href="{{url('')}}"><img src="{{asset($template->logo_besar)}}"
            class="mr-2" alt="logo" /></a>

        <a class="navbar-brand brand-logo-mini" href="{{url('')}}"><img src="{{asset($template->logo_kecil)}}"
            alt="logo" /></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="theme-setting-wrapper">
        ...
        <div id="settings-trigger" data-bs-toggle="tooltip" data-bs-placement="top"
          ...
          <a href="https://chat.whatsapp.com/GvD84msreXaGaHc1ScbNUP"
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              ...
              <li class="list active">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face1.jpg') }}" alt="image"><span
              ...
              <li class="list">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face2.jpg') }}" alt="image"><span
              ...
              <li class="list">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face3.jpg') }}" alt="image"><span
                    class="online"></span></div>
              ...
              <li class="list">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face4.jpg') }}" alt="image"><span
                    class="offline"></span></div>
              ...
              <li class="list">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face5.jpg') }}" alt="image"><span
                    class="online"></span></div>
              ...
              <li class="list">
                ...
                <div class="profile"><img src="{{ asset('layout/skydash/images/faces/face6.jpg') }}" alt="image"><span
                    class="online"></span></div>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          ...
          <a class="navbar-brand brand-logo m-0" href="{{url('')}}"><img src="{{asset($template->logo_kecil)}}"
              alt="logo" />BrainWave</a>

          <a class="navbar-brand brand-logo-mini m-0" href="{{url('')}}"><img src="{{asset($template->logo_kecil)}}?v=1"
              alt="logo" /></a>
        ...
        <ul class="nav">
          ...
          {{-- @php
          $posts = DB::select('
          SELECT * FROM paket_kategori
          WHERE deleted_by IS NULL
          AND EXISTS (
          SELECT 1 FROM paket_mst
          WHERE paket_mst.fk_paket_kategori = paket_kategori.id
          AND paket_mst.is_gratis = 0
          )
          ');
          ...
          <li class="nav-item" id="paket' . $post->id . '">
            <a class="nav-link collapsed" data-bs-toggle="collapse" href="#paketdata' . $post->id . '"
              aria-expanded="false" aria-controls="paketdata' . $post->id . '">
              <i class="icon-grid menu-icon"></i>
            ...
            <div class="collapse" id="paketdata' . $post->id . '" style="">
              <ul class="nav flex-column sub-menu">';
                ...
                echo '<li class="nav-item"><a class="nav-link"
                    href="' . url('belipaket') . '/' . Crypt::encrypt($data->id) . '">' . $data->judul . '</a></li>';
                }
          ...
          <li class="nav-item {{$menu=='belipaketktg' ? 'active' : '' }}">
            ...
            <a class="nav-link _nav-link" href="#" _ceklink="belipaketktg" _link="{{url('belipaketktg')}}">
              ...
              <span class="menu-title">Beli Kelas</span>
          ...
          <li class="nav-item {{$menu=='paketsayaktg' ? 'active' : 'nonactive' }}">
            ...
            <a class="nav-link collapsed" data-bs-toggle="collapse" href="#paketsayaktg" aria-expanded="false"
              aria-controls="paketsayaktg">
            ...
            <div class="collapse" id="paketsayaktg" style="">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                $cekdata = App\Models\Transaksi::where('fk_user_id', Auth::user()->id)->where('status',
                1)->pluck('fk_paket_kategori');
                ...
                echo '<li class="nav-item"><a class="nav-link"
                    href="' . url('paketsayasubktg') . '/' . Crypt::encrypt($data->id) . '">' . $data->judul . '</a>
                </li>';

                }

                @endphp
                <li class="nav-item"><a class="nav-link" href="{{url('paketgratis')}}">Kelas Gratis</a></li>
          ...
          <li class="single-sidebar-menu mt-3">
            <div class="menulabel">pengaturan</div>
            <!---->
          </li>
