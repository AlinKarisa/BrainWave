        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if(Auth::user()->user_level==1)
            @if (Auth::user()->role_id !== null)
              @php $role_menu = App\Models\RoleMenu::where('role_id', Auth::user()->role_id)->pluck('menu')->toArray(); @endphp
              ...
              @if (in_array('Informasi', $role_menu))
                <li class="nav-item">
                  <a href="{{url('informasi')}}" class="nav-link {{$menu=='informasi' ? 'active' : '' }}">
              ...
              @if (in_array('Bank Soal', $role_menu) || in_array('Kategori Paket', $role_menu) || in_array('Paket Latihan', $role_menu) || in_array('Paket Pembelian', $role_menu) || in_array('Kategori Materi', $role_menu) || in_array('Voucher', $role_menu) || in_array('Kecermatan', $role_menu))
                <li class="nav-item {{$menu=='master' ? 'menu-open' : '' }}">
                  ...
                  @if (in_array('Kecermatan', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                  ...
                  @if (in_array('Kategori Paket', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{url('paketkategori')}}" class="nav-link {{$submenu=='paketkategori' ? 'active' : '' }}">
                  ...
                  @if (in_array('Paket Latihan', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{url('paketsoalmst')}}" class="nav-link {{$submenu=='paketsoalmst' ? 'active' : '' }}">
                ...
                <!--  @endif                    -->
                  ...
                  @if (in_array('Paket Pembelian', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{url('paketmst')}}" class="nav-link {{$submenu=='paketmst' ? 'active' : '' }}">
                  ...
                  {{-- @if (in_array('Kategori Meteri', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{url('kategorimateri')}}" class="nav-link {{$submenu=='kategorimateri' ? 'active' : '' }}">
                          <i class="fas fa-project-diagram"></i>
                          <p>
                          Kategori Soal
                          </p>
                  ...
                  @if (in_array('Voucher', $role_menu))
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{url('kodepotongan')}}" class="nav-link {{$submenu=='kodepotongan' ? 'active' : '' }}">
              ...
              @if (in_array('Role Menu', $role_menu))
                <li class="nav-item">
                  <a href="{{url('role-menu')}}" class="nav-link {{$menu =='role_menu' ? 'active' : '' }}">
              ...
              @if (in_array('Paket', $role_menu))
                <li class="nav-item {{$menu=='transaksi' ? 'menu-open' : '' }}">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="{{url('listtransaksi/paket')}}" class="nav-link {{$submenu=='paket' ? 'active' : '' }}">
