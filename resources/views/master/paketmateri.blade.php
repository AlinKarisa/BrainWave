              ...
              <span data-toggle="tooltip" data-placement="left" title="Tambah Data">
                ...
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                   ...
                   <td width="15%" class="_align_center"><a target="_blank" href="{{$key->link}}">Link/File</a></td>
                    <td>{{$key->ket}}</td>
          ...
          <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
            ...
            <div class="modal-body">
              <div class="katsel">
                ...
                <div class="form-group">
                  <label for="jenis_{{$key->id}}">Jenis Materi<span class="bintang">*</span></label>
                  <select name="jenis[]" id="jenis_{{$key->id}}" class="jenismateri form-control" idjenis="{{$key->id}}">
                    <option value="2" {{$key->jenis==2 ? 'selected' : ''}}>Drive</option>
                  </select>
                </div>

                <div class="form-group video_link_{{$key->id}}">
