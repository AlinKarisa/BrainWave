                  ...
                  <td width="1%" class="_align_center">
                    ...
                    <div class="btn-group">
                      ...
                      @if(count($cekdata)<=0) <span data-toggle="tooltip" data-placement="left" title="Hapus Data"> 
                        ...
                        <span data-toggle="tooltip" data-placement="left" title="Harap hapus data pada paket pembelian terlebih dahulu">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <label for="jenis_soal_{{$key->id}}">Jenis Soal</label>
    
                <select name="jenis_soal[]" id="jenis_soal_{{$key->id}}" class="jenissoal form-control" idwaktu="{{$key->id}}">
    
                  <option value="0" {{$key->jenis_soal==0 ? "selected" : ""}}>Pilihan Ganda / Campuran</option>
    
                  <option value="1" {{$key->jenis_soal==1 ? "selected" : ""}}>Hanya Kecermatan</option>
          ...
          <div class="waktu_pengerjaan_{{$key->id}} {{$key->jenis_soal==1 ? 'hide' : ''}}">
          ...
          <div class="form-group">
            ...
            <label for="kkm_{{$key->id}}">Passing Grade</label>
      ...
      <form method="post" id="_formData" class="form-horizontal">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="jenis_soal_add">Jenis Soal</label>
            ...
            <select name="jenis_soal_add" id="jenis_soal_add" class="jenissoal form-control" idwaktu="add">
              ...
              <option value="0">Pilihan Ganda / Campuran</option>
              ...
              <option value="1">Hanya Kecermatan</option>
          ...
          <div class="form-group">
            ...
            <label for="kkm_add">Passing Grade</label>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('change', '.jeniswaktu', function(e) {
      ...
      $(document).on('change', '.jenissoal', function(e) {
    var jenisSoal = $(this).val();
    var idSoal = $(this).attr('idwaktu');

    // Hide 'jenis_waktu' if the selected 'jenis_soal' is Kecermatan (value = 1)
    if (jenisSoal == 1) {
      $(".waktu_pengerjaan_" + idSoal).hide(); // Hide waktu_pengerjaan
      $(".waktu_pengerjaan_" + idSoal).find("select").val(1); // Clear selected value
    } else {
      $(".waktu_pengerjaan_" + idSoal).show(); // Show waktu_pengerjaan for other types of soal
    }
  });
