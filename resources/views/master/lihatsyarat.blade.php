...
<h1 class="m-0">Syarat {{$user->name}}</h1>
@endsection

@section('contentheadermenu')
<ol class="breadcrumb float-sm-right">
    <!-- <li class="breadcrumb-item"><a href="{{url('user')}}">User</a></li> -->
    <li class="breadcrumb-item"><a class="_kembali" href="{{url('lihattransaksi')}}/{{Crypt::encrypt($user->id)}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="25%">{{$key->ket}}</td>
                    <td width="5%" class="_align_center">
                        <span data-toggle="tooltip" data-placement="left" title="Lihat">
                            <button onclick="modalImage('{{$key->judul}}','{{asset($key->foto)}}')" class="btn btn-sm btn-outline-success"><i class="fas fa-eye"></i></button>
                        </span>
                    </td>
                  </tr>
                  @endforeach
...
<script>
  $(document).ready(function(){
    ...
    datatablelihatsyarat("tabledata");
