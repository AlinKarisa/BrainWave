              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                ...
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td class="_align_center">{{$key->tipe==1 ? formatRupiah($key->jumlah) : $key->jumlah."%"}}</td>

                    <td width="1%" class="_align_center">{{$key->batas}}</td>

                    @php

                          $cekterpakai = App\Models\Transaksi::where('fk_promo_id','=',$key->id)->where('status',1)->get();

                      @endphp

                    <td width="1%" class="_align_center">{{count($cekterpakai)}}</td>
                    ...
                    <td width="1%" class="_align_center">
                      ...
                      <span data-toggle="tooltip" data-placement="left" title="Lihat Pengguna">

                              <a href="{{url('kodepotongan/lihat')}}/{{$key->id}}" class="btn btn-sm btn-outline-success"><i class="fas fa-th-list"></i></a>
            ...
            <div class="modal-body">
              ...
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group">
                  ...
                  <label for="batas_{{$key->id}}">Batas<span class="bintang">*</span></label>


                    <input type="text" class="int form-control" id="batas_{{$key->id}}" name="batas[]" placeholder="Masukkan Batas" value="{{$key->batas}}">
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group batas_add">

                <label for="batas_add">Batas<span class="bintang">*</span></label>


                  <input type="text" class="int form-control" id="batas_add" name="batas_add" placeholder="Masukkan Batas">
