          ...
          <div class="col-lg-6 mx-auto px-5">
            <div class="row">
              ...
              <div class="brand-logo mb-4 mt-4 pt-2 mt-md-0 pt-md-0 pb-3">
                <a href="{{url('/')}}"><img src="{{asset($template->logo_besar)}}?v=111" alt="logo"></a>
              </div>
              <div class="text-center mb-3">
                <h4 class="fw-600 text-blue fs-4">Masuk</h4>
                <div class="text-sm"> Masukkan alamat email dan password yang terdaftar </div>
              </div>
              <div class="text-left py-0 px-0 px-sm-2">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="email" class="form-control form-control-sm rounded-2" id="username" name="username" placeholder="Masukkan Email">
                </div>
                <div class="form-group mb-3">
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <label class="form-check-label text-muted ms-3 ps-2">
                    <input type="checkbox" class="form-check-input">
                    Ingat Saya
                  </label>
                  </div>
                  <a href="{{url('lupapassword')}}" class="auth-link text-blue fw-600">Lupa Kata Sandi?</a>
                </div>
                <div class="mt-3">
                  <button type="submit" class="btn rounded-2 btn-block btn-primary font-weight-medium auth-form-btn bg-blue">Masuk</button>
                  <!-- <a href="{{url('auth/google')}}" class="btn btn-block btn-primary btn-sm font-weight-medium auth-form-btn">LOOGIN GOOGLE</a> -->
                  <a href="{{url('auth/google')}}" type="button" class="btn rounded-2 btn-block btn-google auth-form-btn text-white">
                ...
                <a href="{{url('buatakun')}}" class="btn rounded-2 btn-block btn-primary font-weight-medium auth-form-btn text-blue register-btn w-100 fw-600">Daftar</a>
                </form>
              </div>
              </div>
            </div>
