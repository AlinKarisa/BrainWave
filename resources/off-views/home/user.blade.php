      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://ardata.co.id/wp-content/uploads/2024/03/2.jpg" class="d-block w-100" alt="Banner 1">
          </div>
          <div class="carousel-item">
            <img src="https://ardata.co.id/wp-content/uploads/2024/03/1.jpg" class="d-block w-100" alt="Banner 2">
          </div>
          <div class="carousel-item">
            <img src="https://ardata.co.id/wp-content/uploads/2024/05/Tugas-Polisi-berdasarkan-masing-masing-unit-e1716972964525.webp" class="d-block w-100" alt="Banner 3">
          </div>
        </div>
              ...
              <div class="card-body px-3 py-3">
                <div class="row align-items-center">
                  <div class="col-3 pe-0">
                    <div class="icon-card bg-blue rounded-circle"><img src="{{ asset('image/global/Icon1.png') }}" alt="" width="100%"></div>
                  </div>
                  <div class="col-9 ps-3">
                    <div class="fw-600">Paket Tersedia</div>
                    <div class="fs-5 fw-bold text-blue mt-2">{{ count($paket) }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <a href="{{ url('paketsayaktg') }}">
            <div class="card">
              <div class="card-body px-3 py-3">
                <div class="row align-items-center">
                  <div class="col-3 pe-0">
                    <div class="icon-card bg-blue rounded-circle"><img src="{{ asset('image/global/Icon2.png') }}" alt="" width="100%"></div>
                  </div>
                  <div class="col-9 ps-3">
                    <div class="fw-600">Paket Saya</div>
            ...
            <div class="card">
              <div class="card-body px-3 py-3">
                <div class="row align-items-center">
                  ...
                  <div class="col-9 ps-3">
                    <div class="fw-600">Bank Soal</div>
            ...
            <div class="card">
              <div class="card-body px-3 py-3">
                <div class="row align-items-center">
                  ...
                  <div class="col-9 ps-3">
                    <div class="fw-600">Total Pengguna</div>
            ...
            <div class="card-body px-2 py-2">
              ...
              <div class="row">
                <div class="col text-center mb-2">
                  <a href="https://tiktok.com/@orangdalam" class="social-link">
                    <img src="{{ asset('image/global/tt-icon.svg') }}" style="height: 30px; margin-bottom: 5px;">
                    <div class="social-text">orangdalam</div>
                  </a>
                </div>
                <div class="col text-center mb-2">
                  <a href="https://www.instagram.com/official.orangdalam/" class="social-link">
                    <img src="{{ asset('image/global/ig-icon.svg') }}" style="height: 30px; margin-bottom: 5px;">
                    <div class="social-text">@official.orangdalam</div>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="col-12 col-lg-6 col-md-6 d-flex mb-3 mb-md-0">
          <div class="card bg-blue text-white w-100 banner-home">
            <div class="card-body px-4 py-4 w-50">
              ...
              <div class="text-sm mb-3">Belajar dan Berlatih lebih Mudah untuk Raih Cita-Citamu Bersama Orang Dalam</div>
              <a class="btn btn-primary bg-yellow text-white rounded-pill text-white text-center py-2 border-0 text-xs px-4 mt-2" href="https://api.whatsapp.com/send/?phone=6281240280088&text=Halo+orang+dalam%21+Saya+ingin+bertanya+tentang...&type=phone_number&app_absent=0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 29 28" fill="none">
        ...
        <div class="col-12 col-lg-6 col-md-6 d-flex mb-3 mb-md-0">
          <div class="card w-100">
            <div class="card-body px-3 py-3">
              ...
              <div class="mb-3">Selamat Datang di Bimbel Orang Dalam. Belajar dan Berlatih lebih Mudah untuk Raih Cita-Cita CPNS & Kedinasan</div>
        ...
        <!-- <div class="col-12 col-lg-6 col-md-6 d-flex mb-3 mb-md-0">
          <div class="card w-100">
            <div class="card-body px-3 py-3">
              ...
              <div class="mb-3">Orang Dalam menjadi Bimbel Populer di Indonesia, sudah Ramai direkomendasi oleh Para Lulusan Sekolah CPNS dan Kedinasan</div>
              <div class="embed-responsive embed-responsive-16by9">
