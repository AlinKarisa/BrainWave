    ...
    <div class="col-md-12">
      <div class="row">
        <div class="col-12 col-xl-12 mb-4 mb-xl-0">
          <h3 class="font-weight-bold">Ubah Alamat</h3>
          ...
          <div id="profiltab" class="tab-pane active"><br>
              <form id="formUserSetting" class="form-horizontal" method="post">
                    @csrf
                      ...
                      <input type="hidden" name="id_data" value="{{Crypt::encrypt($alamat->id)}}">
                      <div class="form-group row">
                        <label for="nama_penerima" class="col-sm-2 col-form-label">Nama Penerima</label>
                        <div class="col-sm-10">
                          <input name="nama_penerima" type="text" class="form-control" id="nama_penerima" placeholder="Nama Penerima" value="{{$alamat->nama_penerima}}"> 
                        </div>
                      </div>
                      <!-- <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="no_hp_penerima" type="text" class="form-control int" id="no_hp_penerima" placeholder="Nomor Hp" value="{{$alamat->no_hp_penerima}}"> 
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control form-control-lg _select2" id="provinsi" name="provinsi">
                            ...
                            <option value="{{$key['province_id']}}" {{$key["province_id"]==$alamat->fk_provinsi ? "selected" : ""}}>{{$key['province']}}</option>
                            @endforeach
                          </select>
                        </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control form-control-lg _select2" id="kabupaten" name="kabupaten">
                          ...
                          <option value="{{$key['city_id']}}" {{$key["city_id"]==$alamat->fk_kabupaten ? "selected" : ""}}>{{$key['type']." ".$key['city_name']}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea name="alamat_lengkap" id="alamat_lengkap" rows="5" class="form-control" placeholder="Alamat Lengkap">{{$alamat->alamat_lengkap}}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="kode_pos" type="text" class="form-control int" id="kode_pos" placeholder="Kode POS" maxlength="10" value="{{$alamat->kode_pos}}"> 
                        </div>
                      </div>
