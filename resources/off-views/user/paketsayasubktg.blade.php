            ...
            <div class="col-md-4 mb-4 stretch-card">
                <div class="card">
                  <div class="card-body py-4">
					...
					<a href="{{url('paketsaya')}}/{{Crypt::encrypt($key->id)}}" class="hrefpaket btn btn-primary bg-green text-white rounded-pill d-flex align-items-center justify-content-center">Pilih Paket <i class="ti-arrow-right ms-2" style="font-size: 10pt;"></i></a>
                  </div>
                </div>
