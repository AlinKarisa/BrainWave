            ...
            <div class="cardx card-border w-100">
                <div class="card-bodyx">
                    ...
                    <div class="row mt-3">
                        <div class="col-xl-9 col-md-9 col-sm-9 col-xs-9">
                            <div class="_soal_content tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade {{$no==1 ? 'show active' : ''}}" id="pills-{{$key->id}}" role="tabpanel">
                    ...
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">1</button>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button id="btn_no_soal_{{$key->id}}" class="btn-sm {{$key->jawaban_user ? '_ada_isi' : ''}} nav-link {{$no==1 ? 'active' : ''}}" data-bs-toggle="pill" data-bs-target="#pills-{{$key->id}}" type="button" role="tab" aria-selected="true">{{$key->no_soal}}</button>
                                    </li>
                                    @php
                                    $no++;
                                    @endphp
    ...
    <div class="modal-dialog">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            ...
            <div class="modal-footer" style="display:block;text-align: center;border-top:0px solid">
                <button type="button" class="btn btn-primary" id="btn-lanjutsesi" upaketsoalmst="{{Crypt::encrypt($upaketsoalmst->id)}}" upaketsoalktg="{{Crypt::encrypt($idupaketsoalktg)}}">Lanjut Sesi</button>
