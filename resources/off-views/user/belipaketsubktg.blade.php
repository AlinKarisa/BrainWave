                    ...
                    <div class="row mb-3 align-items-center" style="flex-wrap: nowrap !important;">
					  <div class="col-2">
						...
						<div class="col-auto ps-0 align-self-start">
							<div class="rounded-1 px-1 py-1 bg-lightgreen text-green text-xs" style="font-size: 9pt;">Tersedia</div>
						</div>
                    </div>
					
					<a href="{{url('belipaket')}}/{{Crypt::encrypt($key->id)}}" class="hrefpaket btn btn-primary bg-green text-white rounded-pill d-flex align-items-center justify-content-center">Pilih Paket <i class="ti-arrow-right ms-2" style="font-size: 10pt;"></i></a>
                  </div>
                </div>
