  ...
  <div class="row">    
    <div class="col-xl-9 col-md-9 col-sm-9 col-xs-9">
      ...
      <div class="row">
        ...
        <div class="d-none d-lg-block d-md-block text-center">
                  <!--<h6 class="text-danger" style="text-align:center;padding-top:75px">Soal ada pada kotak<br>di bawah ini</h6>-->
                  <h6 class="text-danger" style="text-align:center;">Soal ada pada kotak<br>di bawah ini</h6>
                  <a class="arrow down">Down</a>
        </div>
      </div>
      <div class="row">
        ...
        @if($soalmst->waktu_total)
          ...
          <ul class="nav nav-pills d-block text-center" role="tablist" style="border-bottom:unset">
          @foreach($soalmst->u_paket_soal_kecermatan_soal_dtl_r as $i=>$key)
          <li class="nav-item d-inline-block" style="margin:0;">
          <btn class="btn btn-sm btn-primary" onclick="ganti_soal({{$key->id}})">{{$i+1}}</btn>
          </li>
          @endforeach
          </ul>
          </div>
    ...
    <div style="margin-top:8px;">
      <button type="button" data-bs-toggle="modal" data-bs-target="#modalselanjutnya" class="btn btn-success btn-sm">
        <h6>Soal Selanjutnya</h6>
      </button>
    </div>
    </div>
  </div>
