              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="15%" class="_align_center"><a target="_blank" href="{{$key->jenis==1 ? $key->link : asset($key->link) }}">Link/File</a></td>
                    <td>{{$key->ket}}</td>
                ...
                <div class="form-group {{$key->jenis==2 ? '' : 'hide'}} materi_link_{{$key->id}}">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="input-pdf custom-file-input" name="materi[]" id="materi_{{$key->id}}" idlabel="label-materi-{{$key->id}}">
