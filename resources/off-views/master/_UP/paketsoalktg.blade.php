            ...
            <div class="modal-body">
              ...
              <!-- <div class="card-body"> -->
                ...
                <div class="form-group {{$datamst->is_kkm==0 ? 'd-none' : ''}}">
                    ...
                    <label for="kkm_{{$key->id}}">KKM Perkategori<span class="bintang">*</span></label>

                    <input type="text" class="form-control int" id="kkm_{{$key->id}}" name="kkm[]" placeholder="KKM Perkategori" value="{{$key->kkm}}">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              ...
              <div class="form-group {{$datamst->is_kkm==0 ? 'd-none' : ''}}">
                  ...
                  <input type="text" class="form-control int" id="kkm_add" name="kkm_add" placeholder="KKM Perkategori" value="0">
