...
<h1 class="m-0">Paket Hadiah</h1>
@endsection

@section('contentheadermenu')
<ol class="breadcrumb float-sm-right">
    <!-- <li class="breadcrumb-item">Master</li> -->
    <!-- <li class="breadcrumb-item active">Paket Hadiah</li> -->
    <li class="breadcrumb-item"><a class="_kembali" href="{{url('mapelmst')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a></li>
              ...
              <!-- <button data-toggle="modal" data-target="#modal-tambah" type="button" class="btn btn-md btn-primary btn-absolute">Tambah</button> -->
                <table id="tabledata" class="table  table-striped">
                  ...
                  <tr>
                    ...
                    <td width="15%" class="_align_center">
                      <img class="hover" onclick="modalImage('{{$key->judul}}','{{asset($key->foto)}}')" width="100%" src="{{asset($key->foto)}}">
                    </td>
                    <td style="white-space:nowrap" width="1%" class="_align_right">{{formatRupiah($key->harga)}}</td>
                    <td style="white-space:nowrap" width="1%" class="_align_right">{{$key->berat}} Gram</td>
                    <td width="1%" class="_align_center">
                      <div class="btn-group">
                        ...
                        @php
                          $cekdata = App\Models\Keranjang::where('fk_paket_hadiah_id',$key->id)->get();
                        @endphp
                        @if(count($cekdata)<=0)
                        ...
                        @else
                          <span data-toggle="tooltip" data-placement="left" title="Data tidak dapat dihapus">
        ...
        <div class="modal-content">
          ...
          <form method="post" id="formData_{{$key->id}}" class="form-horizontal">
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <input type="hidden" name="iddata[]" value="{{Crypt::encrypt($key->id)}}">
                ...
                <div class="form-group">
                <label for="berat_{{$key->id}}">Berat<span class="bintang">*</span></label>
                <div class="input-group">
                  <input type="text" class="form-control int" id="berat_{{$key->id}}" name="berat[]" placeholder="Berat" value="{{$key->berat}}">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_{{$key->id}}" class="form-horizontal">
            ...
            <input type="hidden" name="iddata[]" value="{{Crypt::encrypt($key->id)}}">
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus paket hadiah {{$key->judul}}?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          @csrf
          <input type="hidden" name="fk_mapel_mst" value="{{Crypt::encrypt($idmapel)}}">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <label for="berat_add">Berat<span class="bintang">*</span></label>
                <div class="input-group">
                  <input type="text" class="form-control int" id="berat_add" name="berat_add" placeholder="Berat" value="0">
                  <div class="input-group-append">
                    <span class="input-group-text">Gram</span>
                  </div>
                </div>
        ...
        $('#formData_'+idform).validate({
          ...
          messages: {
            ...
            'harga[]': {
              ...
              min: "Harga tidak boleh kosong"
            },
            'berat[]': {
              required: "Berat tidak boleh kosong",
              min: "Berat tidak boleh kosong"
            }
          },
          errorElement: 'span',
