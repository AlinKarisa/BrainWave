              ...
              <div class="card-body">
                  ...
                  <table id="tabledata" class="table  table-striped">
                    ...
                    @foreach($mastersoal as $key)
                      @php
                          $cekdata = App\Models\PaketSoalKecermatanDtl::where('fk_paket_soal_kecermatan_mst',$data->id)->where('fk_master_soal_kecermatan',$key->id)->first();
                          if($cekdata){
                            $valcek = 'checked';
                          }else{
                            $valcek = '';
...
<td width="1%">{{ optional($key->kategori_soal_kecermatan_r)->judul ?? '-' }}</td>
                          @if($key->waktu_total)
